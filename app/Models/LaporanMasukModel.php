...
class LaporanMasukModel extends Model
{
    ...
    {
        return $this->db->table($this->table)
            ->select('barang_masuk.*, inventaris.harga_beli, inventaris.nama_inventaris, ms_barang_masuk.waktu,ms_barang_masuk.keterangan')
    ...
    {
        return $this->db->table($this->table)
            ->select('barang_masuk.*, inventaris.nama_inventaris,inventaris.harga_beli, ms_barang_masuk.waktu,ms_barang_masuk.keterangan')
            ->join('inventaris', 'inventaris.id_inventaris = barang_masuk.id_inventaris')
            ->join($this->tableMsBarangMasuk, 'ms_barang_masuk.id_ms_barang_masuk = barang_masuk.id_ms_barang_masuk')
            ->where('DATE(ms_barang_masuk.waktu) >=', $start_date)
            ->where('DATE(ms_barang_masuk.waktu) <=', $end_date)
    ...
    {
        return $this->db->table($this->table)
            ->select('barang_masuk.*, inventaris.stok, inventaris.harga_beli, inventaris.nama_inventaris, ms_barang_masuk.waktu,ms_barang_masuk.keterangan')
            ->join('inventaris', 'inventaris.id_inventaris = barang_masuk.id_inventaris')
            ->join($this->tableMsBarangMasuk, 'ms_barang_masuk.id_ms_barang_masuk = barang_masuk.id_ms_barang_masuk')
            ->get()
            ->getResultArray();
