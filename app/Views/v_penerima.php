<div class="container-fluid">
    <div class="flex-box pb-1">
        <div class="col-12 mb-1 p-0">
            <a href="<?= base_url('penerima/tambahpenerima/') ?>" method="post" class="btn btn-primary btn-sm">Tambah Penerima</a>
        </div>
    </div>
    <!-- Page Heading -->
    <!-- DataTales Example -->
