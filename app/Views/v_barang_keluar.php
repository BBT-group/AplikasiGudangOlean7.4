                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-1">
                                    ...
                                    <input type="text" class="form-control update-field" id="penerima" name="penerima" value="<?= (old('penerima')) ? old('penerima') : session()->get('penerima_keluar');  ?>">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control update-field <?php if (isset($validate)) {
                                                                                        ...
                                                                                        }  ?>" id="keterangan" name="keterangan" value="<?= (old('keterangan')) ? old('keterangan') : session()->get('keterangan_keluar'); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
